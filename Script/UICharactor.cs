...
public class UICharactor : MonoBehaviour
{
    ...
    void Update()
    {
        m_nCount = m_pMNInfoScript.C_LoadNInfo(MultipleInfo.E_NINFO.E_GOLD);
        m_nGoldScore = m_pMNInfoScript.C_LoadNInfo(MultipleInfo.E_NINFO.E_GOLDSCORE);
        m_nTotalScore = m_pMNInfoScript.C_LoadNInfo(MultipleInfo.E_NINFO.E_SCORE);
